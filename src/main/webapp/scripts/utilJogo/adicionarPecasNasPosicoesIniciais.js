...
function adicionarPecasNasPosicoesIniciais(cor_1, cor_2, corBlocos){
	cor1=cor_1;
	cor2=cor_2;
	anexarImagemMagoNaCelula('celula-02', `./imagens/materia_fria${cor1}.png`);
	anexarImagemMagoNaCelula('celula-03', `./imagens/energia_fria${cor1}.png`);
	anexarImagemMagoNaCelula('celula-04', `./imagens/tempo_frio${cor1}.png`);
	anexarImagemMagoNaCelula('celula-05', `./imagens/mente_fria${cor1}.png`);
	anexarImagemMagoNaCelula('celula-06', `./imagens/espaço_frio${cor1}.png`);
	anexarImagemMagoNaCelula('celula-82', `./imagens/materia_quente${cor2}.png`);
	anexarImagemMagoNaCelula('celula-83', `./imagens/energia_quente${cor2}.png`);
	anexarImagemMagoNaCelula('celula-84', `./imagens/tempo_quente${cor2}.png`);
	anexarImagemMagoNaCelula('celula-85', `./imagens/mente_quente${cor2}.png`);
	anexarImagemMagoNaCelula('celula-86', `./imagens/espaço_quente${cor2}.png`);
